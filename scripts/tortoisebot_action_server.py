...
from tortoisebot_waypoints.msg import WaypointFeedback, WaypointResult, WaypointAction
...
class WaypointActionClass(object):
    ...
    _feedback = WaypointFeedback()
    _result = WaypointResult()
    ...
    def __init__(self):
        ...
        self._as = actionlib.SimpleActionServer("tortoisebot_as", WaypointAction, self.goal_callback, False)
        self._as.start()
